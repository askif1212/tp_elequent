...
<x-layout>
    <div class="container mx-auto p-4">
        ...
        <div class="flex justify-center mb-6">
            <img src="{{ includes($produit->image, 'placehold') ? $produit->image : asset('storage/' . $produit->image) }}"
                alt="No image" class="w-1/2 h-auto rounded-lg shadow-lg">
        </div>
                ...
                <tbody>
                    <tr class="hover:bg-gray-100">
                        ...
                        <td class="px-4 py-2 border-b text-center">
                            <a href="{{ route('produits.edit', ['id' => $produit->id]) }}"
